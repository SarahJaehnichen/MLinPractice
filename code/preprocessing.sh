...
python -m code.preprocessing.run_preprocessing data/preprocessing/labeled.csv data/preprocessing/preprocessed.csv --development --punctuation --tokenize --lemmatize --stemming -e data/preprocessing/pipeline.pickle
